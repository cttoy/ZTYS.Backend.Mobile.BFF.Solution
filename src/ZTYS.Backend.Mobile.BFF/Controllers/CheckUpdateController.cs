        ...
        public AppVersion Get(int versionCode, string versionName, string platformType)
        {
            ...
            if (versionCode < newVersionCode)
            {
                var newAppVersion = new AppVersion
                {
                    ...
                    VersionName = "1.0.6",
                    UpdateDigest = "1.修改路况地图的默认中心为县府 \\n2.修改加油站和车辆维修地图的中心为第一个商家的坐标",
                    ForcedUpdate = false,
                    PackageDownloadUrl = "https://ysxjtysj.oss-cn-beijing.aliyuncs.com/ztys/ztys-1.0.6.apk"
                };
